...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            ...
            <a href="{{route('favorites.index')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
...
<div class="box-body">
    <div class="alert alert-info alert-dismissible">
        ...
        <i class="icon fa fa-inbox alert alert-success"> Success Login!</i>
        <br>
